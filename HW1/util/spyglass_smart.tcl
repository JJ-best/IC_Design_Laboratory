...
# read file
read_file -type verilog ../hdl/rop3_smart.v
# timing constraint
...
capture spyglass_rop3_smart.rpt {write_report moresimple}
...
capture -append spyglass_rop3_smart.rpt {write_report moresimple}
