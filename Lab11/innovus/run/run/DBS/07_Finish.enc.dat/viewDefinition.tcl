...
create_constraint_mode -name CN_func\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/CN_func/CN_func.sdc]
create_analysis_view -name AV_max -constraint_mode CN_func -delay_corner DC_max -latency_file ${::IMEX::dataVar}/mmmc/views/AV_max/latency.sdc
create_analysis_view -name AV_min -constraint_mode CN_func -delay_corner DC_min -latency_file ${::IMEX::dataVar}/mmmc/views/AV_min/latency.sdc
