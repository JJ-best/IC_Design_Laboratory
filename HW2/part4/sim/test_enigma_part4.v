...
`ifdef PAT1
initial begin
    $readmemh("pat/plaintexts1_part4.dat", plain_text);
    $readmemh("pat/ciphertexts1_part4.dat", cipher_text);
    $readmemh("rotor/rotorA.dat", rotorA_text);
    $readmemh("rotor/rotorB.dat", rotorB_text);
end
`elsif PAT2
initial begin
    $readmemh("pat/plaintexts2_part4.dat", plain_text);
    $readmemh("pat/ciphertexts2_part4.dat", cipher_text);
    $readmemh("rotor/rotorA.dat", rotorA_text);
    $readmemh("rotor/rotorB.dat", rotorB_text);
end
`elsif PAT3
initial begin
    $readmemh("pat/plaintexts3_part4.dat", plain_text);
    $readmemh("pat/ciphertexts3_part4.dat", cipher_text);
    $readmemh("rotor/rotorA.dat", rotorA_text);
    $readmemh("rotor/rotorB.dat", rotorB_text);
end
`else
