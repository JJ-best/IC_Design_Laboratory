## ICLAB2025 HW2 Part4 VCS simulation script ##
...
# +define+PAT1: Use pat/plaintexts1_part4.dat and pat/ciphertexts1_part4.dat
# +define+PAT2: Use pat/plaintexts2_part4.dat and pat/ciphertexts2_part4.dat
# +define+PAT3: Use pat/plaintexts3_part4.dat and pat/ciphertexts3_part4.dat
# +define+PAT_LEN={number}: Length of the pattern
# +define+ASCII: Write the decode record to ./result in ASCII format
