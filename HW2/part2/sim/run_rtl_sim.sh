## ICLAB2025 HW2 Part2 VCS simulation script ##
...
# +define+PAT1: Use pat/plaintexts1_part2.dat and pat/ciphertexts1_part2.dat
# +define+PAT2: Use pat/plaintexts2_part2.dat and pat/ciphertexts2_part2.dat
