## ICLAB2025 HW2 Part1 VCS simulation script ##
...
# +define+PAT1: Use pat/plaintexts1_part1.dat and pat/ciphertexts1_part1.dat
# +define+PAT2: Use pat/plaintexts2_part1.dat and pat/ciphertexts2_part1.dat
