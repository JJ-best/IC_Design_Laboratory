...
// behavior_model u_enigma_behavior(
//     // input 
//     .clk(clk),
//     .srst_n(srst_n),
//     .load(load), // load parameter of rotor if load == 1
...
`ifdef PAT1
initial begin
    $readmemh("pat/plaintexts1_part1.dat", plain_text);
    $readmemh("pat/ciphertexts1_part1.dat", cipher_text);
    $readmemh("rotor/rotorA.dat", rotor_text);
end
`elsif PAT2
initial begin
    $readmemh("pat/plaintexts2_part1.dat", plain_text);
    $readmemh("pat/ciphertexts2_part1.dat", cipher_text);
    $readmemh("rotor/rotorA.dat", rotor_text);
end
`else
  initial begin
