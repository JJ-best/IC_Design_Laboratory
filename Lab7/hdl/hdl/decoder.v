...
assign decode_mode = data_buffer[0][2];
always @(*) begin
  if (decode_mode) begin // decode mode == 1
    out = {data_buffer[1][2], data_buffer[2][2], data_buffer[0][1], data_buffer[1][1], data_buffer[2][1], data_buffer[0][0], data_buffer[1][0], data_buffer[2][0]};
  end else begin
    out = {data_buffer[0][1], data_buffer[0][0], data_buffer[1][2], data_buffer[1][1], data_buffer[1][0], data_buffer[2][2], data_buffer[2][1], data_buffer[2][0]};
  end
end

assign valid = (state == READ2 && second_addr != 7'd40)? 1 : 0;
assign done = (base_addr == width / 3)? 1 : 0;
endmodule
