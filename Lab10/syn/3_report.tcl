...
# ===== Timing report =====
report_timing -delay min -max_paths 4 > ./$RPT_DIR/report_hold_${TOPLEVEL}.out
report_timing -delay max -max_paths 4 > ./$RPT_DIR/report_setup_${TOPLEVEL}.out
report_timing -path full -delay max -max_paths 1 -nworst 1 -significant_digits 4 > ./$RPT_DIR/report_time_${TOPLEVEL}.out
...
# ===== resources ===== (resource file for LEC !!!)
report_resources -hier > ./$RPT_DIR/report_resources_${TOPLEVEL}.out
