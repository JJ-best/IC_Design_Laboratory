...
always @(posedge clk) begin
  plug_inverse_i_reg <= plug_inverse_i - RotorA_addr_inverse_shift;
...
always @(*) begin
	case (mode_bitswitch) // synopsys parallel_case full_case
	2'b00: begin
...
wire [(pData_LEN-1):0] RB_mux_i    [0:(pRotorA_LEN-1)]; 
// ---- RotorB mux_i wiring table ----
