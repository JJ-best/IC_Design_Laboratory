## ICLAB2025 HW3 Enigma VCS simulation script ##
...
# +define+PAT1: Use pat/plaintexts1.dat and pat/ciphertexts1.dat
# +define+PAT2: Use pat/plaintexts2.dat and pat/ciphertexts2.dat
# +define+PAT3: Use pat/plaintexts3.dat and pat/ciphertexts3.dat
