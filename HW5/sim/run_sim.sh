...
#+define+SOFTMAX_HEAD0_CHUNK0+PAT_L=0+PAT_U=0 \
#+define+FLAG_VERBOSE=1 \
#+define+FLAG_DUMPWV=1 \
#+define+END_CYCLES=250000
...
#+define+VMUL_HEAD0+PAT_L=0+PAT_U=0 \
#+define+FLAG_VERBOSE=1 \
#+define+FLAG_DUMPWV=1 \
#+define+END_CYCLES=250000
...
#+define+RESIDUAL1+PAT_L=0+PAT_U=0 \
#+define+FLAG_VERBOSE=1 \
#+define+FLAG_DUMPWV=1 \
#+define+END_CYCLES=250000
